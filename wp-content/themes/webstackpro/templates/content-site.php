...
<?php while( have_posts() ): the_post();?>
       ...
       $host = parse_url($url,PHP_URL_HOST);?>
        <div class="mt-2">爱站权重：<span class="mr-2">PC <a title="百度权重" 
        href="https://baidurank.aizhan.com/baidu/<?php echo $host; ?>/" 
        target="nofollow">
        <img title="百度权重" style="height:18px" alt="百度权重" 
        src="//baidurank.aizhan.com/api/br?domain=<?php echo $host;
        ?>&style=images"></a></span><span class="mr-2">移动 
        <a title="百度移动权重"<a href="https://baidurank.aizhan.com/" target="_blank">
        <img src="https://baidurank.aizhan.com/api/mbr?domain=noisevip.cn&style=images" /></a>
        </div>
