                ...
                <div class="media rounded media-5x1">
                    ...
                    <div class="card-img-overlay d-flex justify-content-center text-center flex-column p-3 p-md-4">
                        <h1 class="h4 text-white">—— 公告 ——</h1>
                            <div class="text-xs">
                                <a class="mx-1" href="<?php echo get_permalink(io_get_option('all_bull')) ?>" style="color:#fff;background:#f12345;padding:2px 5px;border-radius:3px;"><small>所有公告</small></a>
                            </div>                
                    </div>
                </div>
            </div>
