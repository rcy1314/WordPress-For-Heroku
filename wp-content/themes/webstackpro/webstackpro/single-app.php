...
<div id="content" class="container my-4 my-md-5">
                ...
                if($sites_type == "down") include( 'templates/site-down-content.php' );
                else include( 'templates/site-content.php' );
                ?>

                <h4 class="text-gray text-lg my-4"><i class="site-tag iconfont icon-tag icon-lg mr-1" id="相关导航"></i>相关导航</h4>
...
<script type='text/javascript'>
    ...
    function check(url){
        ...
        if(tim>100) { 
            clearInterval(timer);
            $.getJSON('https://api.iowen.cn/webinfo/get.php?url='+url,function(data){
                if(data.code==0){
                    msg = '<i class="iconfont icon-crying-circle mr-1" style="color:#f12345"></i>链接超时，网站可能下线了 <i class="iconfont icon-crying"></i>';
                    updateStatus(false);
                }
                else{
