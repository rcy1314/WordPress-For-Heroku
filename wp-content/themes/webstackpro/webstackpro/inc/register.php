...
function theme_load_scripts() {
	...
	if ( io_get_option('fa_cdn')) {
		wp_register_style( 'font-awesome',           '//netdna.bootstrapcdn.com/font-awesome/4.7.0/css/font-awesome.min.css', array(), VERSION, 'all'  );
		wp_register_style( 'font-awesome4',          '//netdna.bootstrapcdn.com/font-awesome/4.7.0/css/font-awesome.min.css', array(), VERSION, 'all'  );
	}else{
