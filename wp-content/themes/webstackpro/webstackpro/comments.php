...
<div class="post-ad mt-4"><?php echo stripslashes( io_get_option('ad_c_c') ); ?></div>
<?php } ?>
			...
			<div id="respond_box">
				<div id="respond" class="comment-respond">
					...
					<div class="rounded bg-light text-center p-4 mb-4">
						...
						<a class="btn btn-light btn-sm btn-rounded" href="<?php echo get_option('siteurl'); ?>/wp-login.php?redirect_to=<?php echo urlencode(get_permalink()); ?>">立即登录</a>
					</div>
    				<?php else : ?>
    				<form action="<?php echo get_option('siteurl'); ?>/wp-comments-post.php" method="post" id="commentform" class="text-sm mb-4">	
						...
						<div class="com-footer text-right">
							...
							<input class="btn btn-dark" name="submit" type="submit" id="submit" tabindex="5" value="<?php _e('发表评论','i_theme') ?>"/>
